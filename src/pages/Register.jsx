...
function Register() {
    ...
    return (
        <div className="flex flex-row h-screen bg-[#F4FEFF]">
            <form onSubmit={handleSubmit} className="flex flex-col space-y-3 py-[23px] px-[50px] w-[800px] mx-auto">
                <h1 className="font-[poppins] text-[30px] flex justify-center">ลงทะเบียนเข้าสู่ระบบ</h1>
                ...
                <label htmlFor="email">
                    ...
                    <input
                        ...
                        name="email"
                        id="email"
                        className="border w-full rounded-full text-[26px] px-4"
                ...
                {/* Height and Weight */}
                <div className="flex gap-x-[58px] justify-center">
                    <label htmlFor="height">
                        ...
                        <input
                            ...
                            name="height"
                            id="height"
                            className="border w-full rounded-full text-[26px] px-2"
                            placeholder="ex.100"
                            value={height}
                ...
                {/* Submit Button */}
                <button type="submit"
                    className="text-1xl w-1/2 flex justify-center mx-auto cursor-pointer text-[#FFFFFF] drop-shadow-lg rounded-full bg-[linear-gradient(-80deg,#007299,#56E0E0)] px-[30px] py-[20px] hover:scale-105 transition-all duration-300 mt-6"
                >ลงทะเบียน</button>
            </form>
        </div>
    );
