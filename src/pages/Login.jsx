...
function Login(){
    ...
    return(
        <div className="flex flex-col h-screen bg-gray-100">
            {/* Login */}
            <div className="flex flex-col p-8  mx-auto items-center gap-y-4 ">
                <img src="src/assets/Pulsematelogo.png" alt="" />
                <h1 className="font-[sarabun] font-bold tracking-wider text-[#444B59] text-[36px]">
                    ยินดีให้บริการ
                </h1>
                <h1 className="font-[sarabun] font-semibold px-2 text-[#444B59] text-[32px]">
                    กรุณาเข้าสู่ระบบ
                </h1>
                <div className="flex flex-col gap-y-4">
                    <label htmlFor="">
                        <h1 className="font-[poppins] text-[24px] text-[#444B59] ">อีเมลล์</h1>
                        <input type="text" name="email" id="email" className="border rounded-full py-1 text-[26px] px-4" placeholder="example@gmail.com">
                        </input>
                    </label>
                    <label htmlFor="password">
                        ...
                        <div className="relative">
                            <input
                                ...
                                name="password"
                                id="password"
                                className="border rounded-full py-1 text-[26px] px-4"
                ...
                <button type="button"
                    className="font-[sarabun] text-[20px] font-bold cursor-pointer text-[#FFFFFF] drop-shadow-lg rounded-full  bg-[linear-gradient(-80deg,#007299,#56E0E0)] px-[25px] py-[20px] hover:scale-105 hover:bg-[linear-gradient(-80deg,#56E0E0,#007299)] transition-all duration-300 mt-6"
                >เข้าสู่ระบบ</button>
                <div className="flex">
                <h1 className="w- flex justify-end text-[20px] text-[#444B59] font-[poppins] ">ลงทะเบียนเพื่อเข้าสู่ระบบ
                </h1>
                <NavLink to="/Register" className="w- flex justify-end text-[20px] text-[#F14336] font-[poppins] ps-2 ">ลงทะเบียน
                </NavLink>
                </div>
            </div>
        </div>
